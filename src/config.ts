...
export const siteConfig: SiteConfig = {
  ...
  banner: {
    ...
    homeText: {
      ...
      title: "Winnie's Secret Garden", // 主页横幅主标题
  ...
  font: {
    ...
    myAwesomeFont: {
      ...
      fontWeight: "400",
      localFonts: ["MyAwesomeFont.ttf"],
      enableCompress: true, // 我的超棒字体，默认先禁用，等下我们再启用它！
    },
    asciiFont: {
      // 英文字体 - 优先级最高
...
export const profileConfig: ProfileConfig = {
  avatar: "assets/images/wenqi.webp", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
  name: "野心家&冒险家",
  bio: "你从不甘心止步于此",
  typewriter: {
